...
exports.Axios = Axios;
},{"./lib/axios.js":"node_modules/axios/lib/axios.js"}],"watchlist.js":[function(require,module,exports) {
"use strict";
...
function addTowatchList(_x) {
  return _addTowatchList.apply(this, arguments);
}
function _addTowatchList() {
  _addTowatchList = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(mediaId) {
    var options;
        ...
        case 0:
          ...
          options = {
            ...
            headers: {
              ...
              "content-type": "application/json",
              Authorization: "Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIwMjMzNWI2OWRjMDgyOGNiMDI5ZTgzN2U1OWRmOGZiYSIsIm5iZiI6MTczNjkwOTkxNS45NTUwMDAyLCJzdWIiOiI2Nzg3MjQ1YjYwMWFjZmU3YmQ0Zjk3YjYiLCJzY29wZXMiOlsiYXBpX3JlYWQiXSwidmVyc2lvbiI6MX0.zdBOfKnmZxXUngIOJRH78BOmdBpMX4xao2I8m48P_yQ"
            },
            body: JSON.stringify({
              media_type: "movie",
              media_id: mediaId,
          ...
          fetch("https://api.themoviedb.org/3/account/21752095/watchlist", options).then(function (res) {
            return res.json();
          }).then(function (res) {
...
function _getWatchList() {
  _getWatchList = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var movies, options;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 3;
          return fetch("https://api.themoviedb.org/3/account/21752095/watchlist/movies?language=en-US&page=1&sort_by=created_at.asc", options).then(function (res) {
            return res.json();
          }).then(function (res) {
            console.log(res);
            movies = res.results;
...
var token = "eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIwMjMzNWI2OWRjMDgyOGNiMDI5ZTgzN2U1OWRmOGZiYSIsIm5iZiI6MTczNjkwOTkxNS45NTUwMDAyLCJzdWIiOiI2Nzg3MjQ1YjYwMWFjZmU3YmQ0Zjk3YjYiLCJzY29wZXMiOlsiYXBpX3JlYWQiXSwidmVyc2lvbiI6MX0.zdBOfKnmZxXUngIOJRH78BOmdBpMX4xao2I8m48P_yQ";
...
function _getMovie() {
  _getMovie = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(url) {
    var movies, name, movieName, prevUrl, response, data;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          infoDump.innerHTML = "";
          _context3.next = 8;
          return (0, _axios.default)(prevUrl);
        case 8:
...
//# sourceMappingURL=/sba308A.e31bb0bc.js.map