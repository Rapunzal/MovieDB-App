...
function createMovie(movies) {
  movies.map(function (movie) {
    ...
    if (movie.backdrop_path !== null) {
      ...
      console.log("https://image.tmdb.org/t/p/w500/".concat(movie.backdrop_path));
      card.append(image);
...
function _getMovie() {
  _getMovie = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var movies, name, movieName, response, data;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 6;
          return (0, _axios.default)("https://api.themoviedb.org/3/search/movie?query=".concat(movieName, "&include_adult=false&language=en-US&page=1"));
        case 6:
